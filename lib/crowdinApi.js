 ...
 * (currently "translated" for success -> straight to Proofreading, or
 * "fallback" for failure/untranslated -> back into the normal AI
 * Pre-translation chain - see manifest.json's placeholder comment, confirm
 * against the real workflow editor before relying on this).
 */
