 ...
 *
 * All AI calls route through lib/anthropic.js, a direct Anthropic Messages
 * API client (see that file's header for why - Crowdin's own AI Prompt
 * Completion endpoint doesn't support the freeform multi-stage reasoning
 * this pipeline needs, only translate/QA-shaped prompts).
 *
 ...
 * Anthropic directly) but is kept as the first parameter on every stage
